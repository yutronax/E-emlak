...
// ASIL ÜRETİM NUMARASI İLE ÇALIŞTIRMAYIN — bu sadece POC/test aşaması içindir.
//
// Kullanım: node connect.js
// İlk çalıştırmada terminale bir QR kod basılır. Test WhatsApp hesabınızda
// Ayarlar > Bağlı Cihazlar > Cihaz Bağla ile bu QR'ı taratabilirsiniz.
...
async function connect() {
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (qr) {
      console.log('\n=== QR KODU (test WhatsApp hesabınızla taratabilirsiniz) ===\n');
